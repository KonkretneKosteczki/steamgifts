export const config = {
    ...
    // the pinned giveaways have review filter applied based on the PinnedGiveaways parameter
    pinnedGiveaways: {applyReviewFilter: true},
    // cannot get review data for games removed from or never added to the store, this parameter affects if such games should be entered
    removedGames: false,
